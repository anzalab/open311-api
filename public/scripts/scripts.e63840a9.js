...
angular.module('ng311').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/dashboards/exports.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Bulk - Exports </div> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <div class=\"padding\"> <div class=\"row\"> <div class=\"col-md-6\"> <div class=\"p-a p-l-none p-b-none\"> <h6 class=\"m-a-0\"> From </h6> </div> <div pickadate ng-model=\"filters.startedAt\" max-date=\"maxDate\" class=\"p-a p-l-none\"></div> </div> <div class=\"col-md-6\"> <div class=\"p-a p-l-none p-b-none\"> <h6 class=\"m-a-0\"> To </h6> </div> <div pickadate ng-model=\"filters.endedAt\" max-date=\"maxDate\" class=\"p-a p-l-none\"></div> </div> </div> <div class=\"row m-t-sm\"> <div class=\"col-md-12\"> <div class=\"p-a p-l-none\"> <h6 class=\"m-a-0\"> Jurisdiction </h6> </div> </div> <div class=\"col-md-3\" ng-repeat=\"jurisdiction in jurisdictions\"> <div class=\"checkbox-custom checkbox-primary p-a p-b-none\"> <input type=\"checkbox\" checklist-model=\"filters.jurisdictions\" checklist-value=\"jurisdiction._id\"> <label class=\"text-muted\" title=\"{{jurisdiction.name}}\">{{jurisdiction.name}}</label> </div> </div> </div> <div class=\"row m-t-md\"> <div class=\"col-md-12\"> <div class=\"p-a p-l-none\"> <h6 class=\"m-a-0\"> Service Group </h6> </div> </div> <div class=\"col-md-3\" ng-repeat=\"servicegroup in servicegroups\"> <div class=\"checkbox-custom checkbox-primary p-a p-b-none\"> <input type=\"checkbox\" checklist-model=\"filters.servicegroups\" checklist-value=\"servicegroup._id\" checklist-change=\"filterServices()\"> <label class=\"text-muted\" title=\"{{servicegroup.name}}\">{{servicegroup.name}}</label> </div> </div> </div> <div class=\"row m-t-md\"> <div class=\"col-md-12\"> <div class=\"p-a p-l-none\"> <h6 class=\"m-a-0\"> Service </h6> </div> </div> <div class=\"col-md-3\" ng-repeat=\"service in services\"> <div class=\"checkbox-custom checkbox-primary p-a p-b-none\"> <input type=\"checkbox\" checklist-model=\"filters.services\" checklist-value=\"service._id\"> <label class=\"text-muted\" title=\"{{service.name}}\">{{service.name}}</label> </div> </div> </div> <div class=\"row m-t-md\"> <div class=\"col-md-12\"> <div class=\"p-a p-l-none\"> <h6 class=\"m-a-0\"> Status </h6> </div> </div> <div class=\"col-md-2\" ng-repeat=\"status in statuses\"> <div class=\"checkbox-custom checkbox-primary p-a\"> <input type=\"checkbox\" checklist-model=\"filters.statuses\" checklist-value=\"status._id\"> <label class=\"text-muted\" title=\"{{status.name}}\">{{status.name}}</label> </div> </div> </div> <div class=\"row m-t-md\"> <div class=\"col-md-12\"> <div class=\"p-a p-l-none\"> <h6 class=\"m-a-0\"> Priority </h6> </div> </div> <div class=\"col-md-2\" ng-repeat=\"priority in priorities\"> <div class=\"checkbox-custom checkbox-primary p-a\"> <input type=\"checkbox\" checklist-model=\"filters.priorities\" checklist-value=\"priority._id\"> <label class=\"text-muted\" title=\"{{priority.name}}\">{{priority.name}}</label> </div> </div> </div> <div class=\"row m-t-md m-b-lg\"> <div class=\"col-md-12\"> <div class=\"pull-right\"> <button class=\"btn btn-primary\" ng-click=\"export()\">Export</button> <button class=\"btn btn-default m-l-sm\" ng-click=\"export(true)\">Clear&nbsp;</button> </div> </div> </div> </div> </div> </div> "
  );


  $templateCache.put('views/dashboards/overviews.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Overview - Reports </div> <ul class=\"nav navbar-nav pull-right\"> <li class=\"nav-item\"> <a ng-click=\"showFilter()\" class=\"nav-link\" aria-expanded=\"false\" title=\"Click to Filter Report\"> <i class=\"ion-android-funnel w-24\" title=\"Click To Filter Reports\"></i> </a> </li> <li class=\"nav-item\" ng-if=\"overviews && overviews.length > 0\"> <a title=\"Click To Export Reports\" class=\"nav-link\" ng-csv=\"export\" csv-header=\"exports.headers\" filename=\"exports.filename\"> <i class=\"icon-cloud-download w-24\" title=\"Click To Export Reports\"></i> </a> </li> </ul> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <div class=\"padding\"> <div> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Service Group</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Service Group </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perGroupConfig\" options=\"perGroupOptions\"></echart> </div> </div> </div> </div> </div> <div> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Area per Service</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Service </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart ng-repeat=\"options in perPerServiceOptions\" config=\"perPerServiceConfig\" options=\"options\"></echart> </div> </div> </div> </div> </div> <div> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Status</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Status </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perStatusConfig\" options=\"perStatusOptions\"></echart> </div> </div> </div> </div> </div> <div> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Priority</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Priorities </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perPriorityConfig\" options=\"perPriorityOptions\"></echart> </div> </div> </div> </div> </div> </div> </div> </div> "
  );
