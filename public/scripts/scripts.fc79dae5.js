...
angular.module('ng311').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/auth/_partials/profile_summary.html',
    " <div class=\"item\"> <div class=\"p-a-lg\"> <div class=\"row m-t\"> <div class=\"col-sm-12 col-md-4 col-lg-6\"> <a href=\"#\" class=\"pull-left m-r-md\"> <span> <letter-avatar title=\"{{party.name}}\" data=\"{{party.name}}\" height=\"96\" width=\"96\" shape=\"round\"> </letter-avatar> <i class=\"on b-white\"></i> </span> </a> <div class=\"clear m-b\"> <h4 class=\"m-a-0 m-b-sm\" title=\"Name\">{{party.name}}</h4> <p class=\"text-muted m-t-sm\"> <span class=\"m-r\" title=\"Relation &amp; Workspace\"> {{party.relation.name ? party.relation.name :'N/A'}} / {{party.relation.workspace ? party.relation.workspace : 'N/A' }} </span> <small title=\"Working Area\"> <i class=\"fa fa-map-marker m-r-xs\"></i> {{party.jurisdiction ? party.jurisdiction.name : 'N/A'}} </small> </p> <div class=\"block clearfix m-b\"> <span> <a href=\"\" class=\"btn btn-icon btn-social rounded b-a btn-sm\"> <i class=\"icon-phone\"></i> <i class=\"icon-phone indigo\"></i> </a> <span title=\"Phone Number\" class=\"text-muted\"> {{party.phone ? party.phone : 'N/A'}} </span> </span> <span class=\"m-l-md\"> <a href=\"\" class=\"btn btn-icon btn-social rounded b-a btn-sm\"> <i class=\"icon-envelope\"></i> <i class=\"icon-envelope light-blue\"></i> </a> <span title=\"Email Address\" class=\"text-muted\"> {{party.email ? party.email : 'N/A'}} </span> </span> </div> </div> </div> <div class=\"col-sm-12 col-md-8 col-lg-6\"> <ng-include ng-if=\"performances.pipelines\" src=\"'views/auth/_partials/service_request_pipelines.html'\"></ng-include> </div> </div> </div> </div> "
  );
