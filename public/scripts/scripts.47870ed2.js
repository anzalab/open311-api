...
angular.module('ng311').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/items/_partials/action_bar.html',
    " <ul class=\"nav navbar-nav\"> <li ng-if=\"edit\" class=\"nav-item\"> <a ng-click=\"onCancel()\" class=\"nav-link text-muted\" title=\"Click to Cancel Item Edit\"> <span class=\"nav-text\"> <i class=\"icon ti-close\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"!edit\" class=\"nav-item\"> <a ng-click=\"onNew()\" class=\"nav-link text-muted\" title=\"Click to Add New Item\"> <span class=\"nav-text\"> <i class=\"icon ti-plus\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"!edit\" class=\"nav-item b-l p-l p-r\"> <a ng-click=\"onEdit()\" class=\"nav-link text-muted no-border\" title=\"Click to edit item\"> <span class=\"nav-text\"> <i class=\"icon-pencil\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"edit\" class=\"nav-item b-l p-l p-r\"> <a ng-click=\"save()\" class=\"nav-link text-muted no-border\" title=\"Click to save item\"> Save </a> </li> </ul> "
  );


  $templateCache.put('views/items/_partials/detail.html',
    " <div class=\"row-col\"> <div class=\"white b-b bg\"> <div ng-include=\"'views/items/_partials/action_bar.html'\" class=\"navbar\"></div> </div> <div class=\"row-row\"> <div class=\"row-body\"> <div class=\"row-inner\"> <div class=\"padding\"> <form ng-submit=\"save()\" name=\"itemForm\" role=\"form\" autocomplete=\"off\" novalidate> <div class=\"box\"> <div class=\"box-body\"> <div class=\"m-b\" title=\"Item Code\"> <div class=\"form-group\"> <label title=\"Item Code\" class=\"floating-label\">Code</label> <input title=\"Item Code\" ng-disabled=\"!edit\" ng-model=\"item.code\" ng-required ng-minlength=\"1\" type=\"text\" name=\"code\" class=\"form-control\"> </div> </div> <div class=\"m-t-lg\" title=\"Item Name\"> <div class=\"form-group\"> <label title=\"Item Name\" class=\"floating-label\">Name</label> <input title=\"Item Name\" ng-disabled=\"!edit\" ng-model=\"item.name\" ng-required ng-minlength=\"2\" type=\"text\" name=\"name\" class=\"form-control\"> </div> </div> <div class=\"m-t-lg\" title=\"Item Unit\"> <div class=\"form-group\"> <label title=\"Item Unit\" class=\"floating-label\">Unit</label> <input title=\"Item Unit\" ng-disabled=\"!edit\" ng-model=\"item.properties.unit\" ng-required ng-minlength=\"2\" type=\"text\" name=\"unit\" class=\"form-control\"> </div> </div> <div class=\"m-t-lg\" title=\"Item Color\"> <color-picker ng-model=\"item.color\"> </color-picker> <div class=\"m-t-lg\"> <div class=\"form-group\"> <label title=\"Item Color\" class=\"floating-label\">Item Color(HEX)</label> <input title=\"Item Color\" ng-disabled=\"!edit\" ng-model=\"item.color\" ng-required ng-minlength=\"1\" type=\"text\" name=\"color\" class=\"form-control\"> </div> </div> </div> <div class=\"m-t-lg\" title=\"Item Description\"> <div class=\"form-group\"> <label class=\"floating-label\">Description</label> <textarea title=\"Item Description\" ng-disabled=\"!edit\" ng-model=\"item.description\" msd-elastic name=\"description\" class=\"form-control\" rows=\"3\">\n" +
    "                    </textarea> </div> </div> </div> </div> </form> </div> </div> </div> </div> </div> "
  );


  $templateCache.put('views/items/_partials/list.html',
    " <div class=\"row-col lt\"> <div class=\"p-a b-b list-search\"> <form> <div class=\"input-group\"> <input type=\"text\" ng-change=\"onSearch()\" ng-model=\"search.q\" class=\"form-control form-control-sm\" placeholder=\"Search Items ...\"> <span class=\"input-group-btn\"> <button class=\"btn btn-default btn-sm no-shadow\" type=\"button\"> <i class=\"ti-search\"></i> </button> </span> </div> </form> </div> <div class=\"row-row\"> <div class=\"row-body scrollable hover\"> <div class=\"row-inner\"> <div class=\"list\" data-ui-list=\"info\"> <div ng-click=\"select(item)\" class=\"list-item list-item-padded\" ng-repeat=\"item in items\" title=\"{{item.description}}\"> <div class=\"list-left\"> <span class=\"w-40 avatar circle\"> <letter-avatar title=\"Item Code\" data=\"{{item.code}}\" height=\"60\" width=\"60\" color=\"{{item.color}}\" shape=\"round\"> </letter-avatar> </span> </div> <div class=\"list-body\"> <span title=\"Item Code\" class=\"pull-right text-xs text-muted\"> {{item.code}} </span> <div class=\"item-title\"> <span title=\"Item Name\" class=\"_500\">{{item.name}}</span> </div> <p title=\"Item Description\" class=\"block text-muted text-ellipsis\"> {{item.description}} </p> </div> </div> </div> </div> </div> </div> <div class=\"p-x-md p-y\"> <div class=\"btn-group pull-right list-pager\" uib-pager ng-show=\"willPaginate()\" total-items=\"total\" ng-model=\"page\" items-per-page=\"limit\" ng-change=\"find()\" template-url=\"views/_partials/list_pager.html\"></div> <span class=\"text-sm text-muted\">Total: {{total}}</span> </div> </div> "
  );
  ...
  $templateCache.put('views/zones/_partials/action_bar.html',
    " <ul class=\"nav navbar-nav\"> <li ng-if=\"edit\" class=\"nav-item\"> <a ng-click=\"onCancel()\" class=\"nav-link text-muted\" title=\"Click to Cancel Zone Edit\"> <span class=\"nav-text\"> <i class=\"icon ti-close\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"!edit\" class=\"nav-item\"> <a ng-click=\"onNew()\" class=\"nav-link text-muted\" title=\"Click to Add New Zone\"> <span class=\"nav-text\"> <i class=\"icon ti-plus\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"!edit\" class=\"nav-item b-l p-l p-r\"> <a ng-click=\"onEdit()\" class=\"nav-link text-muted no-border\" title=\"Click to edit zone\"> <span class=\"nav-text\"> <i class=\"icon-pencil\" aria-hidden=\"true\"></i> </span> </a> </li> <li ng-if=\"edit\" class=\"nav-item b-l p-l p-r\"> <a ng-click=\"save()\" class=\"nav-link text-muted no-border\" title=\"Click to save zone\"> Save </a> </li> </ul> "
  );


  $templateCache.put('views/zones/_partials/detail.html',
    " <div class=\"row-col\"> <div class=\"white b-b bg\"> <div ng-include=\"'views/zones/_partials/action_bar.html'\" class=\"navbar\"></div> </div> <div class=\"row-row\"> <div class=\"row-body\"> <div class=\"row-inner\"> <div class=\"padding\"> <form ng-submit=\"save()\" name=\"zoneForm\" role=\"form\" autocomplete=\"off\" novalidate> <div class=\"box\"> <div class=\"box-body\"> <div class=\"m-b\" title=\"Zone Code\"> <div class=\"form-group\"> <label title=\"Zone Code\" class=\"floating-label\">Code</label> <input title=\"Zone Code\" ng-disabled=\"!edit\" ng-model=\"zone.code\" ng-required ng-minlength=\"1\" type=\"text\" name=\"code\" class=\"form-control\"> </div> </div> <div class=\"m-t-lg\" title=\"Zone Name\"> <div class=\"form-group\"> <label title=\"Zone Name\" class=\"floating-label\">Name</label> <input title=\"Zone Name\" ng-disabled=\"!edit\" ng-model=\"zone.name\" ng-required ng-minlength=\"2\" type=\"text\" name=\"name\" class=\"form-control\"> </div> </div> <div class=\"m-t-lg\" title=\"Zone Color\"> <color-picker ng-model=\"zone.color\"> </color-picker> <div class=\"m-t-lg\"> <div class=\"form-group\"> <label title=\"Zone Color\" class=\"floating-label\">Zone Color(HEX)</label> <input title=\"Zone Color\" ng-disabled=\"!edit\" ng-model=\"zone.color\" ng-required ng-minlength=\"1\" type=\"text\" name=\"color\" class=\"form-control\"> </div> </div> </div> <div class=\"m-t-lg\" title=\"Zone Description\"> <div class=\"form-group\"> <label class=\"floating-label\">Description</label> <textarea title=\"Zone Description\" ng-disabled=\"!edit\" ng-model=\"zone.description\" msd-elastic name=\"description\" class=\"form-control\" rows=\"3\">\n" +
    "                    </textarea> </div> </div> </div> </div> </form> </div> </div> </div> </div> </div> "
  );


  $templateCache.put('views/zones/_partials/list.html',
    " <div class=\"row-col lt\"> <div class=\"p-a b-b list-search\"> <form> <div class=\"input-group\"> <input type=\"text\" ng-change=\"onSearch()\" ng-model=\"search.q\" class=\"form-control form-control-sm\" placeholder=\"Search Zones ...\"> <span class=\"input-group-btn\"> <button class=\"btn btn-default btn-sm no-shadow\" type=\"button\"> <i class=\"ti-search\"></i> </button> </span> </div> </form> </div> <div class=\"row-row\"> <div class=\"row-body scrollable hover\"> <div class=\"row-inner\"> <div class=\"list\" data-ui-list=\"info\"> <div ng-click=\"select(zone)\" class=\"list-item list-item-padded\" ng-repeat=\"zone in zones\" title=\"{{zone.description}}\"> <div class=\"list-left\"> <span class=\"w-40 avatar circle\"> <letter-avatar title=\"Zone Code\" data=\"{{zone.code}}\" height=\"60\" width=\"60\" color=\"{{zone.color}}\" shape=\"round\"> </letter-avatar> </span> </div> <div class=\"list-body\"> <span title=\"Zone Code\" class=\"pull-right text-xs text-muted\"> {{zone.code}} </span> <div class=\"item-title\"> <span title=\"Zone Name\" class=\"_500\">{{zone.name}}</span> </div> <p title=\"Zone Description\" class=\"block text-muted text-ellipsis\"> {{zone.description}} </p> </div> </div> </div> </div> </div> </div> <div class=\"p-x-md p-y\"> <div class=\"btn-group pull-right list-pager\" uib-pager ng-show=\"willPaginate()\" total-items=\"total\" ng-model=\"page\" items-per-page=\"limit\" ng-change=\"find()\" template-url=\"views/_partials/list_pager.html\"></div> <span class=\"text-sm text-muted\">Total: {{total}}</span> </div> </div> "
  );
