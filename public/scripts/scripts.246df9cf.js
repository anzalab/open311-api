...
angular.module('ng311').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/dashboards/operation/_partials/assignees_leaderboard.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-d-md\"> <h3 title=\"Leader board\">Assignee Leader board</h3> <small class=\"block text-muted\" title=\"Rank Based on Attending Service Requests\"> Rank Based on Assigned Service Requests </small> </div> <div class=\"box-tool p-t-sm\"> <ul class=\"nav\"> <li class=\"nav-item inline\"> <a title=\"Click To Export\" class=\"btn btn-xs rounded white\" aria-expanded=\"false\" ng-csv=\"export('assignees')\" csv-header=\"exports.assignees.headers\" filename=\"assignees_operation_reports_{{\n" +
    "              filters.startedAt | date: settings.dateFormat\n" +
    "            }}_{{ filters.endedAt | date: settings.dateFormat }}.csv\"> Export </a> </li> <li uib-dropdown class=\"nav-item inline dropdown\" style=\"display:none\"> <a uib-dropdown-toggle class=\"btn btn-xs rounded white dropdown-toggle\" aria-expanded=\"false\">Today</a> <div uib-dropdown-menu class=\"dropdown-menu dropdown-menu-scale pull-right\"> <a class=\"dropdown-item\" href=\"\">Last 24 hours</a> <a class=\"dropdown-item\" href=\"\">Last 7 days</a> <a class=\"dropdown-item\" href=\"\">Last month</a> <a class=\"dropdown-item\" href=\"\">Last Year</a> <div class=\"dropdown-divider\"></div> <a class=\"dropdown-item\">Today</a> </div> </li> </ul> </div> <div> <div class=\"row-col\"> <div class=\"col-sm-12\"> <table class=\"table table-bordered table-stats\"> <thead> <tr> <th title=\"Material Name\"> Name </th> <th title=\"Total Assigned Service Requests\"> Total </th> <th title=\"Pending Service Requests\"> Pending </th> <th title=\"Resolved Service Requests\"> Resolved </th> <th title=\"Time Taken to Complete Working on a Service Request\"> Work Time </th> </tr> </thead> <tbody> <tr ng-repeat=\"assignee in operations.assignees\"> <td> {{ assignee.name }} </td> <td> {{ assignee.count | number: 0 }} </td> <td> {{ assignee.pending | number: 0 }} </td> <td> {{ assignee.resolved | number: 0 }} </td> <td> <span> {{ assignee.workTime.days * 24 + assignee.workTime.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span> {{ assignee.workTime.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </td> </tr> </tbody> </table> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/operation/_partials/material_used_summary.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-b-md\" title=\"Material Used Summary\"> <h3>Material Used Summary</h3> </div> <div class=\"box-tool p-t-sm\"> <ul class=\"nav\"> <li class=\"nav-item inline\"> <a title=\"Click To Export\" class=\"btn btn-xs rounded white\" aria-expanded=\"false\" ng-csv=\"export('items')\" csv-header=\"exports.items.headers\" filename=\"area_material_usage_reports_{{\n" +
    "              filters.startedAt | date: settings.dateFormat\n" +
    "            }}_{{ filters.endedAt | date: settings.dateFormat }}.csv\"> Export </a> </li> <li uib-dropdown class=\"nav-item inline dropdown\" style=\"display:none\"> <a uib-dropdown-toggle class=\"btn btn-xs rounded white dropdown-toggle\" aria-expanded=\"false\">Today</a> <div uib-dropdown-menu class=\"dropdown-menu dropdown-menu-scale pull-right\"> <a class=\"dropdown-item\" href=\"\">Last 24 hours</a> <a class=\"dropdown-item\" href=\"\">Last 7 days</a> <a class=\"dropdown-item\" href=\"\">Last month</a> <a class=\"dropdown-item\" href=\"\">Last Year</a> <div class=\"dropdown-divider\"></div> <a class=\"dropdown-item\">Today</a> </div> </li> </ul> </div> <div> <div class=\"row-col\"> <div class=\"col-sm-12\"> <table class=\"table table-bordered table-stats\"> <thead> <tr> <th title=\"Material Name\"> Item </th> <th title=\"Quantity of material used\"> Quantity </th> <th title=\"Quantity of material used\"> Units </th> </tr> </thead> <tbody> <tr ng-repeat=\"item in operations.items\"> <td title=\"{{ group.name }}\"> {{ item.name.en }} </td> <td title=\"{{ group.count | number: 0 }}\"> {{ item.count | number: 0 }} </td> <td> {{ item.properties.unit }} </td> </tr> </tbody> </table> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/operation/_partials/overall_time_summary.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-b-md\" title=\"Overview Time Summary\"> <h3>Overview Time Summary</h3> </div> <div class=\"box-tool\"> <ul class=\"nav\"> <li uib-dropdown class=\"nav-item inline dropdown\" style=\"display:none\"> <a uib-dropdown-toggle class=\"btn btn-xs rounded white dropdown-toggle\" aria-expanded=\"false\">Today</a> <div uib-dropdown-menu class=\"dropdown-menu dropdown-menu-scale pull-right\"> <a class=\"dropdown-item\" href=\"\">Last 24 hours</a> <a class=\"dropdown-item\" href=\"\">Last 7 days</a> <a class=\"dropdown-item\" href=\"\">Last month</a> <a class=\"dropdown-item\" href=\"\">Last Year</a> <div class=\"dropdown-divider\"></div> <a class=\"dropdown-item\">Today</a> </div> </li> </ul> </div> <div> <div class=\"row no-gutter\"> <div class=\"col-xs-6 col-sm-4 b-r b-b\" title=\"Average Assign Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Assign Time - Days Spent\"> {{ operations.overall.assignTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Assign Time - Hours Spent\"> {{ operations.overall.assignTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Assign Time - Minutes Spent\"> {{ operations.overall.assignTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Assign Time</p> </div> </div> </div> <div class=\"col-xs-6 col-sm-4 b-r b-b\" title=\"Average Attend Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Attend Time - Days Spent\"> {{ operations.overall.attendTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Attend Time - Hours Spent\"> {{ operations.overall.attendTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Attend Time - Minutes Spent\"> {{ operations.overall.attendTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Attend Time</p> </div> </div> </div> <div class=\"col-xs-6 col-sm-4 b-b\" title=\"Average Completion Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Completion Time - Days Spent\"> {{ operations.overall.completeTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Completion Time - Hours Spent\"> {{ operations.overall.completeTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Completion Time - Minutes Spent\"> {{ operations.overall.completeTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Completion Time</p> </div> </div> </div> </div> <div class=\"row no-gutter\"> <div class=\"col-xs-6 col-sm-4 b-r\" title=\"Average Verification Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Verification Time - Days Spent\"> {{ operations.overall.verifyTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Verification Time - Hours Spent\"> {{ operations.overall.verifyTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Verification Time - Minutes Spent\"> {{ operations.overall.verifyTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Verification Time</p> </div> </div> </div> <div class=\"col-xs-6 col-sm-4 b-r\" title=\"Average Approval Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Approval Time - Days Spent\"> {{ operations.overall.approveTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Approval Time - Hours Spent\"> {{ operations.overall.approveTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Approval Time - Minutes Spent\"> {{ operations.overall.approveTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Approval Time</p> </div> </div> </div> <div class=\"col-xs-6 col-sm-4\" title=\"Average Work Time\"> <div class=\"padding\"> <div class=\"text-center\"> <h3 class=\"text-center _600 m-t-md\"> <span title=\"Average Work Time - Days Spent\"> {{ operations.overall.workTime.average.days }} <span class=\"text-muted text-xs\">days</span> </span> <span title=\"Average Work Time - Hours Spent\"> {{ operations.overall.workTime.average.hours }} <span class=\"text-muted text-xs\">hrs</span> </span> <span title=\"Average Work Time - Minutes Spent\"> {{ operations.overall.workTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </h3> <p class=\"text-muted m-b-md\">Average Work Time</p> </div> </div> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/operation/_partials/services_summary.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-b-md\" title=\"Services Summary\"> <h3>Services Summary</h3> </div> <div class=\"box-tool\"> <ul class=\"nav\"> <li class=\"nav-item inline\"> <a title=\"Click To Export\" class=\"btn btn-xs rounded white\" aria-expanded=\"false\" ng-csv=\"export('services')\" csv-header=\"exports.services.headers\" filename=\"services_operational_reports_{{\n" +
    "              filters.startedAt | date: settings.dateFormat\n" +
  ...
  $templateCache.put('views/dashboards/operation/_partials/workspaces_summary.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-b-md\" title=\"Reporting Workspaces Summary\"> <h3>Workspaces Summary</h3> </div> <div class=\"box-tool p-t-sm\"> <ul class=\"nav\"> <li class=\"nav-item inline\"> <a title=\"Click To Export\" class=\"btn btn-xs rounded white\" aria-expanded=\"false\" ng-csv=\"export('workspaces')\" csv-header=\"exports.workspaces.headers\" filename=\"workspaces_operation_reports_{{\n" +
    "              filters.startedAt | date: settings.dateFormat\n" +
    "            }}_{{ filters.endedAt | date: settings.dateFormat }}.csv\"> Export </a> </li> <li uib-dropdown class=\"nav-item inline dropdown\" style=\"display:none\"> <a uib-dropdown-toggle class=\"btn btn-xs rounded white dropdown-toggle\" aria-expanded=\"false\">Today</a> <div uib-dropdown-menu class=\"dropdown-menu dropdown-menu-scale pull-right\"> <a class=\"dropdown-item\" href=\"\">Last 24 hours</a> <a class=\"dropdown-item\" href=\"\">Last 7 days</a> <a class=\"dropdown-item\" href=\"\">Last month</a> <a class=\"dropdown-item\" href=\"\">Last Year</a> <div class=\"dropdown-divider\"></div> <a class=\"dropdown-item\">Today</a> </div> </li> </ul> </div> <div> <div class=\"row-col\"> <div class=\"col-sm-7\"> <table class=\"table table-bordered table-stats\"> <thead> <tr> <th ng-click=\"prepareWorkspaceVisualization('count')\" title=\"Workspace\"> Workspace </th> <th ng-click=\"prepareWorkspaceVisualization('count')\" title=\"Total Count of Service Requests\"> Total </th> <th ng-click=\"prepareWorkspaceVisualization('pending')\" title=\"Total Pending Count of Service Requests\"> Pending </th> <th ng-click=\"prepareWorkspaceVisualization('resolved')\" title=\"Total Resolved Count of Service Requests\"> Resolved </th> </tr> </thead> <tbody> <tr ng-repeat=\"workspace in operations.workspaces\"> <td title=\"{{ workspace.name }}\"> {{ workspace.name }} </td> <td title=\"{{ workspace.count | number: 0 }}\"> {{ workspace.count | number: 0 }} </td> <td title=\"{{ workspace.pending | number: 0 }}\"> {{ workspace.pending | number: 0 }} </td> <td title=\"{{ workspace.resolved | number: 0 }}\"> {{ workspace.resolved | number: 0 }} </td> </tr> </tbody> </table> </div> <div class=\"col-sm-5 b-l lt\"> <div class=\"p-a-md\"> <echart config=\"perWorkspaceConfig\" options=\"perWorkspaceOptions\"></echart> </div> </div> </div> </div> </div> </div> "
  );


  $templateCache.put('views/dashboards/operation/_partials/zones_summary.html',
    " <div class=\"padding m-t-md\"> <div class=\"box b-a p-l-0\"> <div class=\"box-header b-b p-t-md p-b-md\" title=\"Services Summary\"> <h3>Zone Summary</h3> </div> <div class=\"box-tool\"> <ul class=\"nav\"> <li class=\"nav-item inline\"> <a title=\"Click To Export\" class=\"btn btn-xs rounded white\" aria-expanded=\"false\" ng-csv=\"export('zones')\" csv-header=\"exports.zones.headers\" filename=\"zones_operational_reports_{{\n" +
    "              filters.startedAt | date: settings.dateFormat\n" +
    "            }}_{{ filters.endedAt | date: settings.dateFormat }}.csv\"> Export </a> </li> <li uib-dropdown class=\"nav-item inline dropdown\" style=\"display:none\"> <a uib-dropdown-toggle class=\"btn btn-xs rounded white dropdown-toggle\" aria-expanded=\"false\">Today</a> <div uib-dropdown-menu class=\"dropdown-menu dropdown-menu-scale pull-right\"> <a class=\"dropdown-item\" href=\"\">Last 24 hours</a> <a class=\"dropdown-item\" href=\"\">Last 7 days</a> <a class=\"dropdown-item\" href=\"\">Last month</a> <a class=\"dropdown-item\" href=\"\">Last Year</a> <div class=\"dropdown-divider\"></div> <a class=\"dropdown-item\">Today</a> </div> </li> </ul> </div> <div> <table class=\"table table-bordered table-stats\"> <thead> <tr> <th title=\"Zone Name\"> Zone </th> <th title=\"Total Count of Service Requests in Waiting State\"> Total </th> <th title=\"Total Count of Service Requests in Assigned State\"> Assigned </th> <th title=\"Total Count of Service Requests in Attending State\"> Attending </th> <th title=\"Total Count of Service Requests in Completed State\"> Completed </th> <th title=\"Total Count of Service Requests in Verified State\"> Verified </th> <th title=\"Total Count of Service Requests in Approved State\"> Approved </th> <th title=\"Average Time Taken from Confirmation of Service Request to Assign Service Request\"> Average Assign Time </th> <th title=\"Average Time Taken to work on a Service Request(completeTime - Assign Time)\"> Average Work Time </th> <th title=\"Average Time Taken to Resolve Service Request\"> Average Resolution Time </th> </tr> </thead> <tbody> <tr ng-repeat=\"zone in operations.zones\"> <td title=\"{{ zone.name }}\"> {{ zone.name.en }} </td> <td title=\"{{ zone.new | number: 0 }}\"> {{ zone.count | number: 0 }} </td> <td title=\"{{ zone.new | number: 0 }}\"> {{ zone.assigned | number: 0 }} </td> <td title=\" {{ zone.attended | number: 0 }}\"> {{ zone.attended | number: 0 }} </td> <td title=\" {{ zone.completed | number: 0 }}\"> {{ zone.completed | number: 0 }} </td> <td title=\" {{ zone.verified | number: 0 }}\"> {{ zone.verified | number: 0 }} </td> <td title=\" {{ zone.approved | number: 0 }}\"> {{ zone.approved | number: 0 }} </td> <td> <span> {{ zone.assignTime.average.hours + zone.assignTime.average.days * 24 }} <span class=\"text-muted text-xs\">hrs</span> </span> <span> {{ zone.assignTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </td> <td> <span> {{ zone.workTime.average.hours + zone.workTime.average.days * 24 }} <span class=\"text-muted text-xs\">hrs</span> </span> <span> {{ zone.workTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </td> <td> <span> {{ zone.resolveTime.average.hours + zone.resolveTime.average.days * 24 }} <span class=\"text-muted text-xs\">hrs</span> </span> <span> {{ zone.resolveTime.average.minutes }} <span class=\"text-muted text-xs\">mins</span> </span> </td> </tr> </tbody> </table> </div> </div> </div> "
  );


  $templateCache.put('views/dashboards/operation/index.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Operations - Reports </div> <ul class=\"nav navbar-nav pull-right\"> <li class=\"nav-item\"> <a ng-click=\"showFilter()\" class=\"nav-link\" aria-expanded=\"false\" title=\"Click to Filter Report\"> <i class=\"ion-android-funnel w-24\" title=\"Click To Filter Reports\"></i> </a> </li> </ul> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <ng-include ng-if=\"operations.services  && operations.services.length > 0\" src=\"'views/dashboards/operation/_partials/jurisdiction_summary.html'\"></ng-include> <ng-include ng-if=\"operations.services  && operations.services.length > 0\" src=\"'views/dashboards/operation/_partials/overall_summary.html'\"></ng-include> <ng-include ng-if=\"operations.services  && operations.services.length > 0\" src=\"'views/dashboards/operation/_partials/overall_time_summary.html'\"></ng-include> <ng-include ng-if=\"operations.workspaces  && operations.workspaces.length > 0\" src=\"'views/dashboards/operation/_partials/workspaces_summary.html'\"></ng-include> <ng-include ng-if=\"operations.services  && operations.services.length > 0\" src=\"'views/dashboards/operation/_partials/services_summary.html'\"></ng-include> <ng-include ng-if=\"operations.zones  && operations.zones.length > 0\" src=\"'views/dashboards/operation/_partials/zones_summary.html'\"></ng-include> <ng-include ng-if=\"operations.items  && operations.items.length > 0\" src=\"'views/dashboards/operation/_partials/material_used_summary.html'\"></ng-include> <ng-include ng-if=\"operations.assignees  && operations.assignees.length > 0\" src=\"'views/dashboards/operation/_partials/assignees_leaderboard.html'\"></ng-include> <div class=\"padding\" style=\"display: none\"> <div class=\"row m-t-lg\"> <div class=\"col-sm-12 col-md-5 col-lg-5\"> <ng-include ng-if=\"operations.operators\" src=\"'views/dashboards/_partials/service_request_leaderboard.html'\"></ng-include> </div> <div class=\"col-sm-12 col-md-5 col-lg-5 offset-md-1\"> <ng-include ng-if=\"operations.jurisdictions\" src=\"'views/dashboards/_partials/service_request_area_leaderboard.html'\"></ng-include> </div> </div> </div> <div ng-if=\"operations.services  && operations.services.length === 0\" class=\"row-col h-v\"> <div class=\"row-cell v-m\"> <div class=\"text-center col-sm-6 offset-sm-3 p-y-lg\"> <p class=\"text-muted m-y-lg\"> No Data Found. Please update your filters. </p> <button ng-click=\"showFilter()\" class=\"btn btn-outline b-grey text-grey\" title=\"Click to update filters\"> Update Filters </button> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/overviews/index.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Overview - Reports </div> <ul class=\"nav navbar-nav pull-right\"> <li class=\"nav-item\"> <a ng-click=\"showFilter()\" class=\"nav-link\" aria-expanded=\"false\" title=\"Click to Filter Report\"> <i class=\"ion-android-funnel w-24\" title=\"Click To Filter Reports\"></i> </a> </li> </ul> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <ng-include ng-if=\"overviews.services && overviews.services.length > 1\" src=\"'views/dashboards/overviews/_partials/overall_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.jurisdictions && overviews.jurisdictions.length > 1\" src=\"'views/dashboards/overviews/_partials/jurisdictions_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.groups && overviews.groups.length > 0\" src=\"'views/dashboards/overviews/_partials/service_groups_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.groups && overviews.types.length > 0\" src=\"'views/dashboards/overviews/_partials/service_types_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.services  && overviews.services.length > 0\" src=\"'views/dashboards/overviews/_partials/services_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.channels  && overviews.channels.length > 0\" src=\"'views/dashboards/overviews/_partials/channels_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.workspaces  && overviews.workspaces.length > 0\" src=\"'views/dashboards/overviews/_partials/workspaces_summary.html'\"></ng-include> <ng-include ng-if=\"overviews.operators && overviews.operators.length > 0\" src=\"'views/dashboards/overviews/_partials/operators_leaderboard.html'\"></ng-include> </div> <div ng-if=\"overviews.services && overviews.services.length === 0\" class=\"row-col h-v\"> <div class=\"row-cell v-m\"> <div class=\"text-center col-sm-6 offset-sm-3 p-y-lg\"> <p class=\"text-muted m-y-lg\"> No Data Found. Please update your filters. </p> <button ng-click=\"showFilter()\" class=\"btn btn-outline b-grey text-grey\" title=\"Click to update filters\"> Update Filters </button> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/performance/index.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Performance - Report </div> <ul class=\"nav navbar-nav pull-right\"> <li class=\"nav-item\"> <a ng-click=\"showFilter()\" class=\"nav-link\" aria-expanded=\"false\" title=\"Click to Filter Report\"> <i class=\"ion-android-funnel w-24\" title=\"Click To Filter Reports\"></i> </a> </li> </ul> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <ng-include ng-if=\"performances.services  && performances.services.length > 0\" src=\"'views/dashboards/performance/_partials/jurisdiction_summary.html'\"></ng-include> <div class=\"row no-gutter\"> <div class=\"col-xs-12 col-sm-6 col-md-6\"> <ng-include ng-if=\"performances.services  && performances.services.length > 0\" src=\"'views/dashboards/performance/_partials/overall_summary.html'\"></ng-include> </div> <div class=\"col-xs-12 col-sm-6 col-md-6\"> <ng-include ng-if=\"performances.statuses && performances.statuses.length > 0\" src=\"'views/dashboards/performance/_partials/pipeline_summary.html'\"></ng-include> </div> </div> <ng-include ng-if=\"performances.groups && performances.groups.length > 0\" src=\"'views/dashboards/performance/_partials/service_groups_summary.html'\"></ng-include> <ng-include ng-if=\"performances.services  && performances.services.length > 0\" src=\"'views/dashboards/performance/_partials/services_summary.html'\"></ng-include> <div class=\"padding\" style=\"display: none\"> <div class=\"row m-t-lg\"> <div class=\"col-sm-12 col-md-5 col-lg-5\"> <ng-include ng-if=\"performances.operators\" src=\"'views/dashboards/_partials/service_request_leaderboard.html'\"> </div> <div class=\"col-sm-12 col-md-5 col-lg-5 offset-md-1\"> <ng-include ng-if=\"performances.jurisdictions\" src=\"'views/dashboards/_partials/service_request_area_leaderboard.html'\"> </div> </div> </div> <div ng-if=\"performances.services  && performances.services.length === 0\" class=\"row-col h-v\"> <div class=\"row-cell v-m\"> <div class=\"text-center col-sm-6 offset-sm-3 p-y-lg\"> <p class=\"text-muted m-y-lg\"> No Data Found. Please update your filters. </p> <button ng-click=\"showFilter()\" class=\"btn btn-outline b-grey text-grey\" title=\"Click to update filters\"> Update Filters </button> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/dashboards/standings.html',
    " <div class=\"app-header bg b-b bg-white\"> <div class=\"navbar\"> <div class=\"navbar-item pull-left h5 text-md\"> Standing - Reports </div> <ul class=\"nav navbar-nav pull-right\"> <li class=\"nav-item\"> <a ng-click=\"showFilter()\" class=\"nav-link\" aria-expanded=\"false\" title=\"Click to Filter Report\"> <i class=\"ion-android-funnel w-24\" title=\"Click To Filter Reports\"></i> </a> </li> <li class=\"nav-item\" ng-if=\"standings && standings.length > 0\"> <a title=\"Click To Export Reports\" class=\"nav-link\" ng-csv=\"export\" csv-header=\"exports.headers\" filename=\"standings.csv\"> <i class=\"icon-cloud-download w-24\" title=\"Click To Export Reports\"></i> </a> </li> </ul> </div> </div> <div class=\"app-body\"> <div class=\"app-body-inner\"> <div class=\"padding\"> <div ng-if=\"perJurisdictionOptions.series[0].data.length > 0\"> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Area - Work Load</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Area </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perJurisdictionConfig\" options=\"perJurisdictionOptions\"></echart> </div> </div> </div> </div> </div> <div ng-if=\"perJurisdictionPerServiceGroupOptions.series.length > 0\"> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3> Issue per Area per Service Group - Affected Business Units(Divisions) </h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Area and Service Group </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perJurisdictionPerServiceGroupConfig\" options=\"perJurisdictionPerServiceGroupOptions\"></echart> </div> </div> </div> </div> </div> <div ng-if=\"perJurisdictionPerServiceOptions.length > 0\"> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Area per Service - Impacted Business Services</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Area and Service </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart ng-repeat=\"options in perJurisdictionPerServiceOptions\" config=\"perJurisdictionPerServiceConfig\" options=\"options\"></echart> </div> </div> </div> </div> </div> <div ng-if=\"perJurisdictionPerPriorityOptions.series.length > 0\"> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Area per Priority - Work Severity</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Area and Priority </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perJurisdictionPerPriorityConfig\" options=\"perJurisdictionPerPriorityOptions\"></echart> </div> </div> </div> </div> </div> <div ng-if=\"perJurisdictionPerStatusOptions.series.length > 0\"> <div class=\"row\"> <div class=\"col-sm-12\"> <div class=\"box\"> <div class=\"box-header\"> <h3>Issue per Area per Status - Work Progress</h3> <small class=\"block text-muted\"> Count of Reported Issues by Their Area and Status </small> </div> <div class=\"box-body p-l-none p-r-none\"> <echart config=\"perJurisdictionPerStatusConfig\" options=\"perJurisdictionPerStatusOptions\"></echart> </div> </div> </div> </div> </div> </div> <div ng-if=\"perJurisdictionOptions.series[0].data.length === 0\" class=\"row-col h-v\"> <div class=\"row-cell v-m\"> <div class=\"text-center col-sm-6 offset-sm-3 p-y-lg\"> <p class=\"text-muted m-y-lg\"> No Data Found. Please update your filters. </p> <button ng-click=\"showFilter()\" class=\"btn btn-outline b-grey text-grey\" title=\"Click to update filters\"> Update Filters </button> </div> </div> </div> </div> </div> "
  );
  ...
  $templateCache.put('views/servicerequests/_partials/operator_filter.html',
    "<div> <div class=\"modal-header\"> <button type=\"button\" class=\"close pull-right\" ng-click=\"$dismiss()\" aria-hidden=\"true\"> × </button> <h4 class=\"modal-title\"> {{isOperatorFilter ? 'Filter by Operator':'Filter By Assignee'}} </h4> </div> <div class=\"modal-body\"> <div class=\"container-fluid\"> <div class=\"row-col lt\"> <div class=\"list-search\"> <form> <div class=\"input-group\"> <input type=\"text\" ng-change=\"onSearchParties('assignees')\" ng-model=\"search.party\" class=\"form-control form-control-sm\" placeholder=\"Search Operator ...\"> <span class=\"input-group-btn\"> <button ng-click=\"onSearchParties('assignees')\" class=\"btn btn-default btn-sm no-shadow\" type=\"button\"> <i class=\"ti-search\"></i> </button> </span> </div> </form> </div> <div class=\"row-row\"> <div class=\"row-body hover\"> <div class=\"list\" data-ui-list=\"info\"> <div class=\"list-item\" ng-repeat=\"assignee in assignees\" title=\"{{assignee.name}}\" ng-click=\"filterByWorker(assignee)\"> <div class=\"list-left\"> <span class=\"w-40 avatar circle\"> <letter-avatar title=\"{{assignee.name}}\" data=\"{{assignee.name}}\" height=\"60\" width=\"60\" shape=\"round\"> </letter-avatar> </span> </div> <div class=\"list-body\"> <div class=\"item-title\"> {{assignee.name}} <br> <span class=\"text-sm text-muted\"> {{assignee.relation.type}} </span> </div> </div> </div> </div> </div> </div> </div> </div> </div> </div> "
  );


  $templateCache.put('views/servicerequests/_partials/quality_control_checks.html',
    " <div class=\"padding b-t\"> <h6 class=\"m-b\" title=\"Root Cause\">Root Cause</h6> <p class=\"text-lt\"> {{servicerequest.cause ? servicerequest.cause.name.en :'N/A'}} </p> </div> <div class=\"padding b-t\"> <h6 class=\"m-b\" title=\"Action Taken\">Action Taken</h6> <p class=\"text-lt\"> {{servicerequest.measure ? servicerequest.measure.name.en :'N/A'}} </p> </div> <div class=\"padding b-t\"> <h6 class=\"m-b\" title=\"Way Forward\">Way Forward</h6> <p class=\"text-lt\"> {{servicerequest.advisory ? servicerequest.advisory.name.en :'N/A'}} </p> </div> "
  );
